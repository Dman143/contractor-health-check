...
for(const text of ['Your Health Check is complete<span className="completion-full-stop">.</span>','I can personally review your answers','I’ll personally review your answers','Download the Free Quick Guide','href="https://www.tradebuilt.pro/"','src="/tradebuilt-logo-cream.png"']) if(!app.includes(text)) throw new Error(`Missing personal-review confirmation content: ${text}`);
